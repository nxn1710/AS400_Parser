...
/**
 * Content model for Display File (DSPF) DDS source.
 * <p>
 * Stored as "content" in {@link com.as400parser.common.model.IrDocument}
 * when sourceType = "DSPF". Follows the same top-level structure as
 * {@link com.as400parser.dds.model.DdsPfContent} for JSON consistency.
 */
public class DspfContent {

    /** All raw source lines (same SourceLine structure as PF/LF and RPG3). */
    private List<SourceLine> sourceLines;

    /** File-level keywords: DSPSIZ, CAxx/CFxx, PRINT, REF, CHGINPDFT, INDARA, etc. */
    private List<DdsKeyword> fileKeywords;

    /** Record format definitions. */
    private List<DspfRecordFormat> recordFormats;
    ...
    public List<DspfRecordFormat> getRecordFormats() {
        return recordFormats;
    }

    public void setRecordFormats(List<DspfRecordFormat> recordFormats) {
