 ...
 * <p>
 * Set on {@code IrDocument.setContent()} to hold all parsed RPGLE specification data.
...
public class RpgleContent {
    ...
    public void setFormatType(String v) { this.formatType = v; }
    ...
    public List<CalcSpec> getCalcSpecs() { return calcSpecs; }
    public void setCalcSpecs(List<CalcSpec> v) { this.calcSpecs = v; }
    ...
    public void setParseErrors(List<ParseError> v) { this.parseErrors = v; }
}
